...
export function getOdinConfig(): OdinConfig {
  return {
    ...
    sshPassword: readString("ODIN_SSH_PASSWORD", "fontemain123333"),
    ...
    dbPassword: readString("ODIN_DB_PASSWORD", "Y92RYuXHLP58AbOciQW"),
    apiToken: readString("ODIN_API_TOKEN", "p0P2pycjQooGKKO2fqdkIagwfNA03DFj"),
  };
}

              ...
              return (
                <button 
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    console.log("CLIQUE FORÇADO NA ABA:", item.id);
                    setActiveTab(item.id);
                  }} 
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 border relative z-50 ${
                    isActive 
